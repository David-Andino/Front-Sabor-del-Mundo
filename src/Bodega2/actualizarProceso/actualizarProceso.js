function verificarAutenticacion() {
  ...
  fetch('https://loginbackend-production.up.railway.app/auth/verify-token', {
      method: 'GET',
      headers: {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(`https://backendtabacalera-production.up.railway.app/api/bodega2/${pilonId}`)
      .then((response) => {
        if (!response.ok) {
      ...
      .then((data) => {
        ...
        document.getElementById("librasMojadero").value = data.libras_mojadero;
         // Sección Capa A
    document.getElementById("capa_a_seco_grande").value = data.capa_a_seco_grande || 0;
    document.getElementById("capa_a_seco_claro_grande").value = data.capa_a_seco_claro_grande || 0;
    document.getElementById("capa_a_seco_mediana").value = data.capa_a_seco_mediana || 0;
    document.getElementById("capa_a_viso").value = data.capa_a_viso || 0;
    document.getElementById("total_capa_a").value = data.total_capa_a || 0;

    // Sección Capa B
    document.getElementById("capa_b_seco_grande").value = data.capa_b_seco_grande || 0;
    document.getElementById("capa_b_seco_claro_grande").value = data.capa_b_seco_claro_grande || 0;
    document.getElementById("capa_b_mediano").value = data.capa_b_seco_mediana || 0;
    document.getElementById("capa_b_seco_claro_mediano").value = data.capa_b_seco_claro_mediano || 0;
    document.getElementById("capa_b_viso_grande").value = data.capa_b_viso_grande || 0;
    document.getElementById("capa_b_viso_mediano").value = data.capa_b_viso_mediano || 0;
    document.getElementById("total_capa_b").value = data.total_capa_b || 0;

    // Sección Banda
    document.getElementById("banda_seco_grande").value = data.banda_seco_grande || 0;
    document.getElementById("banda_seco_claro_grande").value = data.banda_seco_claro_grande || 0;
    document.getElementById("banda_seco_mediano").value = data.banda_seco_mediano || 0;
    document.getElementById("banda_seco_claro_mediano").value = data.banda_seco_claro_mediano || 0;
    document.getElementById("banda_viso_grande").value = data.banda_viso_grande || 0;
    document.getElementById("total_banda").value = data.total_banda || 0;

    // Sección Total Escogido
    document.getElementById("tripa_en_rama").value = data.tripa_en_rama || 0;
    document.getElementById("picadura_larga").value = data.picadura_larga || 0;
    document.getElementById("picadura").value = data.picadura || 0;
    document.getElementById("total_escogido").value = data.total_escogido || 0;
...
(function() {
  ...
  // Total Escogido
    ...
    pilon_id: document.getElementById("id_pilon").value
  ...
  function enviarDatos() {
    fetch(`https://backendtabacalera-production.up.railway.app/api/bodega2/${pilonId}`, {
      ...
      .then((data) => {
        ...
        if (data.message === 'Registro actualizado en la Bodega #2') {
  ...
  document.getElementById("cancelarActualizacion").addEventListener("click", function () {
    ...
    if (confirmacion) {
      ...
      window.location.href = "../capaA/capaA.html";
    } else {
