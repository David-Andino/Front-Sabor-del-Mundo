...
function displayPilones(pilones) {
    ...
    pilones.forEach(pilon => {
        ...
        tr.innerHTML = `
            ...
            <td>${pilon.corte}</td>
            <td>${pilon.etapa}</td>
            <td>${pilon.banda_seco_grande}</td>
            <td>${pilon.banda_seco_claro_grande}</td>
            <td>${pilon.banda_seco_mediano}</td>
            <td>${pilon.banda_seco_claro_mediano}</td>
            <td>${pilon.banda_viso_grande}</td>
            <td>${pilon.total_banda}</td>
            <td>
                <div class="dropdown">
