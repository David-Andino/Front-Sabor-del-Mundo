...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(`https://backendtabacalera-production.up.railway.app/api/bodega3/${pilonId}`)
      .then((response) => {
        if (!response.ok) {
      ...
      .then((data) => {
        ...
        document.getElementById("id_pilon").value = data.pilon_id;
        ...
        document.getElementById("libras_mojadero").value = data.libras_mojadero;

        // Sección Tripa A
        document.getElementById("tripa_desp_seco_grande_a").value = data.tripa_desp_seco_grande_a;
        document.getElementById("tripa_desp_seco_mediana_a").value = data.tripa_desp_seco_mediana_a;
        document.getElementById("tripa_desp_seco_pequeno_a").value = data.tripa_desp_seco_pequeno_a;
        document.getElementById("total_tripa_seco_a").value = data.total_tripa_seco_a;

        document.getElementById("tripa_desp_viso_grande_a").value = data.tripa_desp_viso_grande_a;
        document.getElementById("tripa_desp_viso_mediana_a").value = data.tripa_desp_viso_mediana_a;
        document.getElementById("tripa_desp_viso_pequeno_a").value = data.tripa_desp_viso_pequeno_a;
        document.getElementById("total_tripa_viso_a").value = data.total_tripa_viso_a;

        document.getElementById("tripa_desp_ligero_grande_a").value = data.tripa_desp_ligero_grande_a;
        document.getElementById("tripa_desp_ligero_mediana_a").value = data.tripa_desp_ligero_mediana_a;
        document.getElementById("tripa_desp_ligero_pequeno_a").value = data.tripa_desp_ligero_pequeno_a;
        document.getElementById("total_tripa_ligero_a").value = data.total_tripa_ligero_a;

        // Sección Capa y Banda
        document.getElementById("capa_b_seco_grande").value = data.capa_b_seco_grande;
        document.getElementById("total_capa_b_grande").value = data.total_capa_b_grande;

        document.getElementById("banda_seco_grande").value = data.banda_seco_grande;
        document.getElementById("banda_seco_mediana").value = data.banda_seco_mediana;
        document.getElementById("banda_seco_pequena").value = data.banda_seco_pequena;
        document.getElementById("banda_viso_grande").value = data.banda_viso_grande;
        document.getElementById("total_banda").value = data.total_banda;

        // Sección Tripa B
        document.getElementById("tripa_desp_seco_grande_b").value = data.tripa_desp_seco_grande_b;
        document.getElementById("tripa_desp_seco_mediana_b").value = data.tripa_desp_seco_mediana_b;
        document.getElementById("tripa_desp_seco_pequeno_b").value = data.tripa_desp_seco_pequeno_b;
        document.getElementById("total_tripa_seco_b").value = data.total_tripa_seco_b;

        document.getElementById("tripa_desp_viso_grande_b").value = data.tripa_desp_viso_grande_b;
        document.getElementById("tripa_desp_viso_grande_b_pelotoso").value = data.tripa_desp_viso_grande_b_pelotoso;
        document.getElementById("tripa_desp_viso_mediana_b").value = data.tripa_desp_viso_mediana_b;
        document.getElementById("tripa_desp_viso_mediana_b_pelotoso").value = data.tripa_desp_viso_mediana_b_pelotoso;
        document.getElementById("tripa_desp_viso_pequeno_b").value = data.tripa_desp_viso_pequeno_b;
        document.getElementById("total_tripa_viso_b").value = data.total_tripa_viso_b;

        document.getElementById("tripa_desp_ligero_grande_b").value = data.tripa_desp_ligero_grande_b;
        document.getElementById("tripa_desp_ligero_grande_b_pelotoso").value = data.tripa_desp_ligero_grande_b_pelotoso;
        document.getElementById("tripa_desp_ligero_mediano_b").value = data.tripa_desp_ligero_mediano_b;
        document.getElementById("tripa_desp_ligero_mediano_b_pelotoso").value = data.tripa_desp_ligero_mediano_b_pelotoso;
        document.getElementById("tripa_desp_ligero_pequeno_b").value = data.tripa_desp_ligero_pequeno_b;
        document.getElementById("total_tripa_ligero_b").value = data.total_tripa_ligero_b;

        // Sección Otros
        document.getElementById("pelotoso").value = data.pelotoso;
        document.getElementById("picadura").value = data.picadura;
        document.getElementById("vena").value = data.vena;
        document.getElementById("hojas_verdes").value = data.hojas_verdes;
        document.getElementById("total_despalillo").value = data.total_despalillo;
...
(function() {
  ...
  document.getElementById("guardarCambiosPilon").addEventListener("click", () => {
   ...
   pilon_id: parseInt(document.getElementById("id_pilon").value)
    };
    ...
    fetch(`https://backendtabacalera-production.up.railway.app/api/bodega3/${pilonId}`, {
      ...
      .then((data) => {
        ...
        if (data.message === 'Registro creado en la Bodega #3') {
          ...
          window.location.href = "../Banda/banda.html";
          resetFormulario();
        }
      })
      .catch((error) => {
