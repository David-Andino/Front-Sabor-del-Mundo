...
function displayPilones(pilones) {
    ...
    pilones.forEach(pilon => {
        ...
        tr.innerHTML = `
            ...
            <td>${pilon.corte}</td>
            <td>${pilon.etapa}</td>
            <td>${pilon.tripa_desp_ligero_grande_b}</td>
            <td>${pilon.tripa_desp_ligero_grande_b_pelotoso}</td>
            <td>${pilon.tripa_desp_ligero_mediano_b}</td>
            <td>${pilon.tripa_desp_ligero_mediano_b_pelotoso}</td>
            <td>${pilon.tripa_desp_ligero_pequeno_b}</td>
            <td>${pilon.total_tripa_ligero_b}</td>
            <td>
                <div class="dropdown">
