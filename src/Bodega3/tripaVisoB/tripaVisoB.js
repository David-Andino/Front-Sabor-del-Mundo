...
function displayPilones(pilones) {
    ...
    pilones.forEach(pilon => {
        ...
        tr.innerHTML = `
            ...
            <td>${pilon.corte}</td>
            <td>${pilon.etapa}</td>
            <td>${pilon.tripa_desp_viso_grande_b}</td>
            <td>${pilon.tripa_desp_viso_grande_b_pelotoso}</td>
            <td>${pilon.tripa_desp_viso_mediana_b}</td>
            <td>${pilon.tripa_desp_viso_mediana_b_pelotoso}</td>
            <td>${pilon.tripa_desp_viso_pequeno_b}</td>
            <td>${pilon.total_tripa_viso_b}</td>
            <td>
                <div class="dropdown">
